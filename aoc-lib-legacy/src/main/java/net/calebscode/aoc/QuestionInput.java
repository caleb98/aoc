...
public class QuestionInput {
	...
	public <T> Grid<T> asGrid(Function<Character, T> converter, boolean wrap) {
		return asGrid(converter, wrap, (x, y) -> { 
			throw new IllegalArgumentException("Grid access index out of bounds: (" + x + ", " + y + ")"); 
		});
	}
	
	public <T> Grid<T> asGrid(Function<Character, T> converter, boolean wrap, BiFunction<Integer, Integer, T> outOfBoundsSupplier) {
